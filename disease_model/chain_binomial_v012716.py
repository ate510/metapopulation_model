...
def write_csv_file (incidence_time_series_metro_child, incidence_time_series_metro_adult, tot_incidence_time_series_child, tot_incidence_time_series_adult, disease_intervention, travel_intervention, timing):
    ...
    csvfile = csv.writer(open('/home/anne/Dropbox/Anne_Bansal_lab/Modeling_Project_Outputs/Deterministic_Model/chain_binomial_output_nummetrozeros_%s_numchildzeros_%s_numadultzeros_%s_disease_%s_travel_%s_timing_%s.csv' % (num_metro_zeros, num_child_zeros, num_adult_zeros, disease_intervention, travel_intervention, timing), 'wb'), delimiter = ',')
