...
###################################################
def simmetrize_contacts_average (C_ij, C_ji):
...
# return dictionaries with data from Table 1 in POLYMOD (avg # contacts per agegroup)
    ...
    german_population = [3802280, 4010372, 4642964, (4855500 + 4976730), (4703414 + 6039933), (7176550 + 6707543), (5792802 + 5271033), (4250928 + 5324024)]
    
    d_mean_contacts = dict(zip(age, contacts))
    #d_num_part = dict(zip(age, participants))
    d_num_part = dict(zip(age, german_population))
...
#Apollini 2014 Eq 3
    ...
    Cca = simmetrize_contacts_average(C_ij, C_ji)
...
if __name__ == "__main__":
    ...
    alpha = calc_alpha(year, dict_childpop, dict_adultpop)
    d_pop_for_metro_age = calc_metro_age_pop(filename_metropop, alpha)
    
    #C_ij, C_ji, child, adult = aggregate_contacts(filename_germ_contact_data, filename_germ_pop_data)
    #print Cca
    #print C_ij, C_ji
    
    C = calc_contact_matrix(filename_germ_contact_data, filename_germ_pop_data, alpha)
