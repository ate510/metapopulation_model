...
#  and return the total number of infected individuals (num_infected)
    ...
    return d_metro_infected_child, d_metro_infected_adult, d_nat_infected_child, d_nat_infected_adult, sum(d_nat_infected_child.values()), sum(d_nat_infected_adult.values()) # return total number infected in outbreak
...
if __name__ == "__main__":
    ...
    ch_travelers_r = 0.2 # fraction of children who travel
