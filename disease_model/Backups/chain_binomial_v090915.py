...
### functions ###
import population_parameters_v090915 as pop_func
...
# child
    ...
    plt.show()
    #plt.savefig('/home/anne/Dropbox/Anne_Bansal_lab/Graphs/RR_IR_child_adult/RR_ili_incid_child_adult_thanks_xmas_shifted.png')
    #plt.close()
